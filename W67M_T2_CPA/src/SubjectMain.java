...
public class SubjectMain {
	...
	public static void main(String[] args) {
		...
		public static void viewAllSubjects(ArrayList<Subject1> subjectList) {
			Helper.line(40, "-");
		...
		public static void addSubjects(ArrayList<Subject> subjectList) {
			...
			for (int i = 0; i < subjectList.size(); i ++) {
				if (subjectList.get(i).getSubjectName() == subject ) {
					System.out.println("This Subject Has Been Added!");
					count = true;
				}
			}
			if (count == false) {
				Subject1 addSubject = new Subject1(id, subject);
				subjectList.add(0, addSubject);
			}
		}
		//Delete A Subject For Option 3
		public static boolean deleteSubject(ArrayList<Subject1> subjectList) {
